...
reduced_math_hist <- ggplot(low_income, aes(x=math.score)) + geom_histogram()
reduced_math_hist

reduced_reading_hist <- ggplot(low_income, aes(x=reading.score)) + geom_histogram()
reduced_reading_hist

reduced_writing_hist <- ggplot(low_income, aes(x=math.score)) + geom_histogram()
reduced_writing_hist

high_math_hist <- ggplot(high_income, aes(x=math.score)) + geom_histogram()
high_math_hist

high_reading_hist <- ggplot(high_income, aes(x=reading.score)) + geom_histogram()
high_reading_hist

high_writing_hist <- ggplot(high_income, aes(x=writing.score)) + geom_histogram()
high_writing_hist
